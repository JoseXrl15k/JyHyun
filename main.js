...
do {
let lineM = '⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ 》'
opcion = await question('[ ℹ️ ] Solo la opción 1:\n1. Con código QR\n---> ')
//if (fs.existsSync(`./${authFile}/creds.json`)) {
//console.log(chalk.bold.redBright(`PRIMERO BORRE EL ARCHIVO ${chalk.bold.greenBright("creds.json")} QUE SE ENCUENTRA EN LA CARPETA ${chalk.bold.greenBright(authFile)} Y REINICIE.`))
//process.exit()
if (!/^[1-2]$/.test(opcion)) {
console.log('[ ❗ ] Por favor, seleccione solo 1 o 2.\n')
}} while (opcion !== '1' || fs.existsSync(`./${authFile}/creds.json`))
}
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Jyhuyun', 'Brave', '2.0.0'] : methodCodeQR ? ['Jyhyun', 'Brave', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
auth: {
creds: state.creds,
