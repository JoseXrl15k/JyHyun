...
if (!text) return m.reply(`⚠️ Que estás buscando escriba el comando\n• Ejemplo: ${usedPrefix + command} Jy Hyun`) 
m.react("🥰") 
try {
...
conn.sendFile(m.chat, ss, 'result.png', teks, false);
m.react("✅")                 
handler.limit = 1;      
}} catch (error) {
try {
...
conn.sendFile(m.chat, ss, 'error.png', teks, false)
});
m.react("✅") 
handler.limit = 1;         
} catch (e) {
